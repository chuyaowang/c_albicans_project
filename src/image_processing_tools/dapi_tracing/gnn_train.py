...
def _log_cv_aggregate(log_dir, pooled_preds, mean_threshold):
    ...
    # string may itself contain a slash (notebook 4 uses ".../repeat_<i>" to group repeats
    # of one config), in which case it is a path fragment rather than the repeat's name and
    # matches nothing -- silently emptying the frame.
